...
// All seats ON the circle edge (50% = center, radius ~40%)
...
export default function PokerTable({
  ...
  return (
    <div className="relative mx-auto aspect-square w-full max-w-[340px]">
      {/* Table circle — schematic border only */}
      ...
      {/* Seat positions — all consistently on the circle edge */}
      {positions.map((pos) => {
